...
<div role="main" id="main">	
	...
	?>
	<div id="dialog-register" title="Registered">
		<p>
			<span class="ui-icon ui-icon-check" style="float:left; margin:0 7px 60px 0;"></span>
			Thanks for registering.  Please check your email where you should find your access details.
		</p>
	</div>
</div>
<footer>
