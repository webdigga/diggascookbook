...
<div role="main" id="main">	
	<?php
		require_once($_SERVER['DOCUMENT_ROOT'].'/pages/login-register.php');		
	?>
	<div id="dialog-reminder" title="Reminder">
		<p>
			<span class="ui-icon ui-icon-check" style="float:left; margin:0 7px 60px 0;"></span>
			Please check your email where you should find your access details.
		</p>
	</div>
</div>
<footer>
